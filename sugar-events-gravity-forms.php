			...
			echo '<td class="sc_meta_box_td" colspan="4">';
				...
				echo '<select name="sc_event_gf_form">';
					...
					foreach( $forms as $form ) {
						...
						echo '<option value="' . $form->id . '" ' . selected( $selected_form, $form->id, false ) . '>' . $form->title . '</option>';
				...
				echo '</p>';
					...
					echo '<input type="hidden" name="scgf_meta_box_nonce" value="' . wp_create_nonce(basename(__FILE__)) . '" />';
